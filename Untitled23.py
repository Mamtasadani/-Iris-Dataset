...
import pickle
#Step 1:Understanding your data using descriptive statistics and visualization.
...
for name, model in models:
    ...
    print(msg)
#print('\n Thus the LinearDiscriminantAnalysis algorithm found to best suite this dataset \n')
#Step4 :Improving results using algorithm parameter tuning.
...
#Step 5 :Improving results using ensemble methods.
